...
public class FullBigFractionArithmetic implements IValueArithmetic<BigFraction> {
	...
	public BigFraction div(BigFraction a, long b) {
		...
		// The numerator may exceed long internally; the final value generator performs the range clamp.
		if (result.getDenominator().compareTo(BigInteger.valueOf(Long.MAX_VALUE)) > 0) {
