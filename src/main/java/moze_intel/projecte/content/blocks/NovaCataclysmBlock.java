 ...
 */
public class NovaCataclysmBlock extends TntBlock {
    private static final float EXPLOSION_POWER = 16.0F;
    private static final Field EXPLOSION_POWER_FIELD;

    static {
        try {
            EXPLOSION_POWER_FIELD = PrimedTnt.class.getDeclaredField("explosionPower");
            EXPLOSION_POWER_FIELD.setAccessible(true);
